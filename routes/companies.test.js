...
describe("GET /companies", function () {
  ...
  test("works: filter by name, minEmployees", async function(){
    const resp = await request(app)
    .get(`/companies/?name=${filters.name}&minEmployees=${filters.minEmployees}`)
    expect(resp.body).toEqual({
      companies:
          [
            {
  ...
  test("works: filter by name, maxEmployees", async function(){
    const resp = await request(app)
    .get(`/companies/?name=${filters.name}&maxEmployees=${filters.maxEmployees}`)
    expect(resp.body).toEqual({
      companies:
          [
            {
  ...
  test("works: filter by minEmployees, maxEmployees", async function(){
    const resp = await request(app)
    .get(`/companies/?minEmployees=${filters.minEmployees}&maxEmployees=${filters.maxEmployees}`)
    expect(resp.body).toEqual({
      companies:
          [
            {
  ...
  test("works: filter by name", async function(){
    const resp = await request(app)
    .get(`/companies/?name=${filters.name}`)
    expect(resp.body).toEqual({
      companies:
          [
            {
  ...
  test("works: filter by maxEmployees", async function(){
    const resp = await request(app)
    .get(`/companies/?maxEmployees=${filters.maxEmployees}`)
    expect(resp.body).toEqual({
      companies:
          [
            {
  ...
  test("works: filter by minEmployees", async function(){
    const resp = await request(app)
    .get(`/companies/?minEmployees=${filters.minEmployees}`)
    expect(resp.body).toEqual({
      companies:
          [
            {
  ...
  test("fails: insert inappropriate filter name", async function(){
    const resp = await request(app).get("/companies/?minEmployees=200&maxEmployees=20");
    expect(resp.statusCode).toEqual(400);
  });
