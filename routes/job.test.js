...
/***********************GET /jobs */
describe("GET /jobs/?filters", function () {
  ...
  test("works: filter by title, minSalary, hasEquity", async function () {
    const resp = await request(app).get(
      `/jobs/?title=${filters.title}&minSalary=${filters.minSalary}&hasEquity=${filters.hasEquity}`
    );
    expect(resp.body).toEqual({
      jobs: [
        {
  ...
  test("works: filter by title and minSalary", async function () {
    const resp = await request(app).get(
      `/jobs/?title=${filters.title}&minSalary=${filters.minSalary}`
    );
    expect(resp.body).toEqual({
      jobs: [
        {
  ...
  test("works: filter by title", async function () {
    const resp = await request(app).get(`/jobs/?title=${filters.title}`);
    expect(resp.body).toEqual({
      jobs: [
        {
          id: expect.any(Number),
  ...
  test("works: filter by title and hasEquity", async function () {
    const resp = await request(app).get(
      `/jobs/?title=${filters.title}&hasEquity=${filters.hasEquity}`
    );
    expect(resp.body).toEqual({
      jobs: [
        {
  ...
  test("works: filter by minSalary and hasEquity", async function () {
    const resp = await request(app).get(
      `/jobs/?minSalary=${filters.minSalary}&hasEquity=${filters.hasEquity}`
    );
    expect(resp.body).toEqual({
      jobs: [
        {
  ...
  test("works: filter by minSalary", async function () {
    const resp = await request(app).get(
      `/jobs/?minSalary=${filters.minSalary}`
    );
    expect(resp.body).toEqual({
      jobs: [
        {
  ...
  test("works: filter by hasEquity", async function () {
    const resp = await request(app).get(
      `/jobs/?hasEquity=${filters.hasEquity}`
    );
    expect(resp.body).toEqual({
      jobs: [
        {
